...
public class HuggingFaceService implements AIService {
    ...
    public HuggingFaceService(HuggingfaceChatModel chatModel, HistorySummarizationService summarizationService) {
    ...
    public ChatResponse chat(
        ...
        ChatOptions options = ChatOptions.builder()
                .model(model != null ? model : "meta-llama/Llama-3.1-8B-Instruct")
