...
public class OpenRouterService implements AIService {
    ...
    public OpenRouterService(RestTemplate restTemplate, AIConfig config, HistorySummarizationService summarizationService) {
    ...
    public PerplexityResponse chat(String userMessage, String model, String format, Double temperature, Integer maxTokens, String systemPromptType, String customSystemPrompt, HttpSession session, Boolean autoSummarize) {
        ...
        String historyKey = "conversationHistory_openrouter";
        ...
        headers.setBearerAuth(config.getOpenrouterApiKey());
        // OpenRouter specific headers
        headers.set("HTTP-Referer", "http://localhost:8080");
        headers.set("X-Title", "AI Exploration");
        ...
        if (responseBody != null) {
            ...
            if (Boolean.TRUE.equals(autoSummarize) &&
                ...
                log.info("Triggering auto-summarization for OpenRouter");
